...
#sed -i 's/ImmortalWrt-2.4G/Xiaomi_72FB/g' package/mtk/applications/mtwifi-cfg/files/mtwifi.sh
#sed -i 's/ImmortalWrt-5G/Xiaomi_72FB_5G/g' package/mtk/applications/mtwifi-cfg/files/mtwifi.sh
sed -i 's/MT7981_AX3000_2.4G/Xiaomi-203/g' package/mtk/drivers/wifi-profile/files/mt7981/mt7981.dbdc.b0.dat
sed -i 's/MT7981_AX3000_5G/Xiaomi-203-5G/g' package/mtk/drivers/wifi-profile/files/mt7981/mt7981.dbdc.b1.dat
