...
sed -i 's/ImmortalWrt-2.4G/Xiaomi-203/g' package/mtk/applications/mtwifi-cfg/files/mtwifi.sh
sed -i 's/ImmortalWrt-5G/Xiaomi-203-5G/g' package/mtk/applications/mtwifi-cfg/files/mtwifi.sh
